...
//       tmc::detail::treat_as_coroutine, std::tuple,
//       Awaitable...>::true_types>;
...
//   template <typename T>
//   using ResultStorage =
//   tmc::detail::result_storage_t<detail::void_to_monostate<
...
//   ) {
//     tmc::detail::get_awaitable_traits<T>::set_continuation(Task,
//     &continuation);
