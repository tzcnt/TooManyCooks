...
[[nodiscard]] inline tiny_mutex_waiter*
tiny_mutex_waiters(uintptr_t Value) noexcept {
  return reinterpret_cast<tiny_mutex_waiter*>(
    Value & ~tiny_mutex_state::RUNNING
  );
}
...
tiny_mutex::enqueue(tmc::detail::tiny_mutex_waiter& Waiter) noexcept {
  ...
  do {
    ...
    desired = reinterpret_cast<uintptr_t>(&Waiter) |
              tmc::detail::tiny_mutex_state::RUNNING;
...
tmc::task<void> tiny_mutex::run_loop(tmc::detail::tiny_mutex_state* State) {
