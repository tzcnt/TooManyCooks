...
TMC_DECL_HWLOC std::vector<tmc::topology::detail::CacheGroup*>
...
TMC_DECL_HWLOC detail::Topology query_internal(
...
TMC_DECL_HWLOC hwloc_obj* find_parent_cache(hwloc_obj* Start);
TMC_DECL_HWLOC void make_cache_parent_group(
...
struct ThreadCacheGroupIterator {
  ...
  TMC_DECL_HWLOC ThreadCacheGroupIterator(
    std::vector<tmc::topology::detail::CacheGroup>&,
    std::function<void(tmc::topology::detail::CacheGroup&)>
  );
  TMC_DECL_HWLOC bool next();
};

TMC_DECL_HWLOC void for_all_groups(
  std::vector<tmc::topology::detail::CacheGroup>&,
  std::function<void(tmc::topology::detail::CacheGroup&)>
);
} // namespace detail
...
TMC_DECL_HWLOC void adjust_thread_groups(
...
TMC_DECL_HWLOC void pin_thread(
...
TMC_DECL_HWLOC tmc::detail::hwloc_unique_bitmap make_partition_cpuset(
...
TMC_DECL_HWLOC tmc::topology::core_group
...
TMC_DECL_HWLOC std::vector<size_t>
...
TMC_DECL_HWLOC std::vector<size_t> get_lattice_matrix(
  std::vector<tmc::topology::detail::CacheGroup> const& groupedCores
);

TMC_DECL_HWLOC std::vector<size_t> get_hierarchical_matrix(
  std::vector<tmc::topology::detail::CacheGroup> const& groupedCores
);
